...
//    public static String IMAGE_PATH_PROP = "fileReference";
    public static String IMAGE_URL_PROP = "./imagetext/linkURL";
    public static String IMAGE_ALT_TEXT_PROP = "./imagetext/alt";
...
//        setImagePath(properties.get(IMAGE_PATH_PROP, ""));
